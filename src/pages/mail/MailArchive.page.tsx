...
import MailSidebarItemPart from './_parts/MailSidebarItem.part';
import Avatar from '../../components/Avatar';
import MailContentViewerPart from './_parts/MailContentViewer.part';
...
export default MailArchivePage;
